# settings.py - UPDATE YOUR INSTALLED_APPS and SIMPLE_JWT sections
...
# Maximum upload size (20MB for receipt images)
...
ALLOWED_RECEIPT_EXTENSIONS = ['jpg', 'jpeg', 'png', 'pdf', 'gif']
